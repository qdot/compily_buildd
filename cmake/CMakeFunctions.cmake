...
FUNCTION(BUILDSYS_BUILD_LIB)
  ...
  PARSE_ARGUMENTS(BUILDSYS_LIB
    "NAME;SOURCES;CXX_FLAGS;LINK_LIBS;LINK_FLAGS;DEPENDS;LIB_TYPES_OVERRIDE;SHOULD_INSTALL;GROUP;EXCLUDE_FROM_ALL;"
    ""
    ${ARGN}
    )
  ...
  FOREACH(LIB_TYPE ${BUILDSYS_LIB_TYPES_LIST})
    ...
    IF(CPACK_PACKAGE_VERSION)
      SET_TARGET_PROPERTIES (${CURRENT_LIB} PROPERTIES SOVERSION ${CPACK_PACKAGE_VERSION})
      SET_TARGET_PROPERTIES (${CURRENT_LIB} PROPERTIES VERSION ${CPACK_PACKAGE_VERSION})
    ENDIF()
